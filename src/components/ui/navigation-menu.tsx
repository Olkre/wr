...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-8 bg-white/25  w-max items-center justify-center rounded-full bg-background px-4 py-1 text-sm font-medium transition-colors hover:text-accent-foreground focus:bg-white hover:bg-white/75 focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50"
);
...
>(({ className, ...props }, ref) => (
  <div
    className={cn("absolute  top-full flex justify-center submenuContainer")}
    id="submenuContainer"
  >
